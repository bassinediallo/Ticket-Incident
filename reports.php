...
<div id="content">
    <div id="reportMain" class="panel panel-default">
        <div class="panel-heading">Rapports</div>
        <div class="panel-body">
		<form method="POST">
		  <div class="form-group row">
		    <label for="reportName" class="col-sm-2 form-control-label">Nom rapport</label>
		    <div class="col-sm-5">
		  ...
		  <div class="form-group row">
		    <label for="startDate" class="col-sm-2 form-control-label">Date debut</label>
		    <div class="col-sm-5">
		  ...
		  <div class="form-group row">
		    <label for="endDate" class="col-sm-2 form-control-label">Date fin</label>
		    <div class="col-sm-5">
		  ...
		  <div class="form-group row">
		    <label for="openedBy" class="col-sm-2 form-control-label">Ouvert par</label>
		    <div class="col-sm-5">
		      <select class="form-control" id="openedBy" name="openedBy" >
		      	<option value="">Selectionner nom utilisateur...</option>
		  ...
		  <div class="form-group row">
		    <label for="category" class="col-sm-2 form-control-label">Categorie</label>
		    <div class="col-sm-5">
		  ...
		  <div class="form-group row">
		    <label for="subCategory" class="col-sm-2 form-control-label">Sous Categorie</label>
		    <div class="col-sm-5">
		  ...
		  <div class="form-group row">
		    ...
		    <select class="form-control"  id="status" name="status">
		    	...
		    	<option value="Waiting on agent">En attente de l'agent</option>
		  ...
		  <div class="form-group row">
		    <div class="col-sm-offset-2 col-sm-5">
		      <button name="createReport" type="submit" class="btn btn-success">Créer</button>
		    </div>
		  </div>
		</form>
