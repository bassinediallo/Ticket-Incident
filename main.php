...
?>
    ...
    <div id="newTicket" class="panel panel-default">
        <div class="panel-heading">Nouveau Ticket</div>
        <div class="panel-body">
            <form class="form-horizontal" method="POST" action="#" enctype="multipart/form-data">
                ...
                <div class="btn-group">
                    <button type="submit" name="addTicket" class="btn btn-primary">Créer</button>
                    <button type="submit" name="addQuickTicket" class="btn btn-success">Créer et fermer</button>
                </div>
                <div class="btn-group">
    ...
    <div id="recentTickets" class="panel panel-default">
        <div class="panel-heading">Tickets recents</div>
            <?php ticket::displayRecentTickets(); ?>

    </div>
<div id="totals" class="well welroundl-sm-2" >
Total Tickets: <?php echo ''. ticket::getTicketCount(); ?> <br>  Moyenne quotidienne: <?php echo ''. ticket::getDailyAverage(); ?>
</div>
