...
<div id="content">
		<div id="displayCategories" class="panel panel-default">
        		<div class="panel-heading">Paramètre du System</div>
				...
				<form class="form" method="post">
				    ...
				    <label for="version" class="col-sm-3 control-label">Version du System</label>
				      <div class="col-sm-8">
				  ...
				  <div class="form-group">
				    <label for="authentication" class="col-sm-3 control-label">Authentification</label>
				      <div class="col-sm-8">
				  ...
				  <div class="form-group">
					...
					<div class="form-group">
				    <label for="brand" class="col-sm-3 control-label">Marque</label>
				      <div class="col-sm-8">
				  ...
				  <div class="form-group">
				 	 ...
				 	 <button class="btn btn-success" name="saveSettings" type="submit">Sauvegarder</button>
				      </div>
				  </div>
		...
		<div id="displayCategories" class="panel panel-default">
        		<div class="panel-heading">Categories</div>
		        	...
		        	<div class="panel-body">
						...
						<button type="submit" name="addCategory" class="btn btn-success">Ajouter Categorie</button>
					</form>
					<form class="form-inline" method="POST">
						<div class="form-group">
						...
						<button type="submit" name="addSubCategory" class="btn btn-success">Ajouter une sous-catégorie</button>
					</form>
				</div>
			</div>
	 		...
	 		<div id="displaySubCategories" class="panel panel-default">
        			<div class="panel-heading">Sous Categories</div>
        			<div class="panel=body">
