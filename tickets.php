...
<nav class="navbar navbar-default navbar-fixed-top navbar-inverse subMenu">
  <div class="navbar-inner container-fluid container-fluid">
    <ul class="nav navbar-nav">
    	<li id="subMenuNew"><a href="./main.php">Nouveau</a></li>
	<li id="subMenuMine"><a href="./tickets.php?ticketId=mine">Mes Tickets</a></li>
	<li id="subMenuAll"><a href="./tickets.php?ticketId=all">Tout les Tickets</a></li>
	<li id="subMenuOpen"><a href="./tickets.php?ticketId=open">Ouvert</a></li>
	<li id="subMenuClient" ><a href="./tickets.php?ticketId=woc">En attente du client</a></li>
	<li id="subMenuAgent" ><a href="./tickets.php?ticketId=woa">En attente de l'agent</a></li>
	<li id="subMenuClosed"><a href="./tickets.php?ticketId=closed">Fermé</a></li>
    </ul>
  </div>
</nav>
...
?>
			...
			<div class="panel-body">
				...
				<form class="form" method="POST" enctype="multipart/form-data">
					...
					<input type="text" name="previousAssignedUser" value="<?php echo '' . $ticket->getAssignedUser();?>" hidden />
			                ...
			                <div class="form-group">
			                    <label for="user" class="col-sm-2 control-label">Crée par:</label>
			                    <div class="col-sm-10">
			                ...
			                <div class="form-group">
			                    <label for="subCategory" class="col-sm-2 control-label">Sous-Catégorie:</label>
			                    <div class="col-sm-10">
			                ...
			                <div class="form-group">
			                    ...
			                    <div class="col-sm-10">
			                        <select class="form-control" name="status">
					        			...
					        			<option value="Waiting on Client">En attente du Client</option>
					        			<option value="Waiting on Agent">WEn attente de l'agent</option>
					        			<option value="Waiting on 3rd Party">En attente d'un tiers</option> 
			                ...
			                <div class="form-group">
			                    <label for="ticketNote" class="col-sm-2 control-label">Ajouter des notes:</label>
			                    <div class="col-sm-10">
 ...
 <?php if($_SESSION['usertype']=='Administrator'){ ?>
			                <div class="form-group">
			                    <label for="group" class="col-sm-2 control-label">Groupe assigné:</label>
			                    <div class="col-sm-10">
 ...
 <?php if($_SESSION['usertype']=='Administrator'){ ?>
			                			<div class="form-group">
												<label for="assignedUser" class="col-sm-2 control-label">Utilisateur assigné:</label>
												<div class="col-sm-10">
 ...
 <?php } ?>
											<div class="form-group">
												<label for="comments" class="col-sm-2 control-label">Télécharger</label>
													<div class="col-sm-10">
														<div class="input-group">
															<input type="text" class="form-control" readonly>
								                <label class="input-group-btn">
								                    <span class="btn btn-default">
													Parcourir...<input id="fileToUpload" name="fileToUpload" type="file" style="display: none;" multiple>
								                    </span>
								                </label>
								            </div>
													</div>
											...
											<div class="form-group">
												 <label for="comments" class="col-sm-2 control-label">Pièces jointes </label>
												 <div class="col-sm-10"><?php $ticket->linkAttachments(); ?></div>
											</div>

											<div class="form-group row">
									      <div class="offset-sm-2 col-sm-10">
									        <button name="updateTicket" class="btn btn-primary" type="submit">Mise à jour</button>
									      </div>
									    </div>
